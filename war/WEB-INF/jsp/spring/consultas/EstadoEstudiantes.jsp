<%-- 
    Document   : EstadoEstudiantes
    Created on : 01-jul-2010, 20:37:07
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function selectGestion(id_ges){
                window.location = '<c:url value="/estadoEstudiante.do"/>?id_gestion='+id_ges;
            }
            ...
            function setImprimirExcelEstado(){
                window.location = '<c:url value="/estadoEstudiante.do"/>?id_gestion=${id_gestion}&id_curso=${id_curso}&categoria=${categoria}&opcion=ESTADO&accion=_imprimir&id_estado=${id_estado}';
            }
        </script>
    </head>
    <body>
        <div class="headercontent">
            <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
                <tr>
                    ...
                    <td style="width:40%">
                        <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
                            <td class="tab_normal" onclick="javascript:window.location='<c:url value="/actualizarEstados.do"/>'">Actualizar estados de estudiantes</td>
                            <td class="tab_current">Estado de estudiantes</td>
                        </table>
                    </td>
                    <td class="tab_fin">&nbsp;</td>
                </tr>
            </table
            <div class="titlepage">ESTADO DE ESTUDIANTES</div>
        </div>
        <div class="maincontent">
            ...
            <c:if test="${!empty question}">
                <form action="<c:url value="/estadoEstudiante.do"/>" method="post" name="formConsultas">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="gridContent">
                        <tr>
                            ...
                            <td width="35%" class="opcionConsulta">Estado de estudiantes</td>
                        </tr>
                        <tr>
                            <td>CURSO</td>
                            ...
                            <td>TIPO</td>
                            <td class="opcionConsulta">
                                <select name="id_estado" class="text-field" style="width:150px">
                                    <option value="T" <c:if test="${id_estado=='T'}">selected</c:if>> TODO
                                        <c:forEach var="items" items="${estados}">
                                        <option value="${items.id}"<c:if test="${items.id == id_estado}"> selected </c:if>> ${items.valor}
                                        </c:forEach>
                                </select>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="5" align="center">
                                <input type="hidden" name="opcion" value="ESTADO">
                    ...
                    <tr>
                        <td>
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td class="text-label"><button class="button-normal"  onclick="setImprimirExcelEstado()" title="Imprimir documento en excel">Imprimir Excel</button>&nbsp;</td>
                            ...
                            <div id="resultlayer1">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF">
                                    <tr>
                                        ...
                                        <td class="gridHeaders" width="40%">Apellidos y nombres</td>
                                        <c:if test="${id_curso!='C'}"><td class="gridHeaders" width="40%">Estado</td></c:if>
                                        <c:if test="${id_curso=='C'}">
                                            <td class="gridHeaders" width="20%">Estado</td>
                                            <td class="gridHeaders" width="20%">Curso</td>
                                        </c:if>
                                    </tr>
                                    ...
                                    <c:forEach varStatus="i" var="item" items="${curso.estudiantes}">
                                        <c:if test="${categoria=='A'}">
                                            <c:if test="${id_estado=='T'}">
                                                <tr onmouseover="onRowover(this)" onmouseout="onRowout(this)">
                                                    ...
                                                    <c:if test="${id_curso!='C'}"><td class="gridData">${item.estado}</td></c:if>
                                                    <c:if test="${id_curso=='C'}">
                                                        <td class="gridData">${item.estado}</td>
                                                        <td class="gridData">${item.curso}</td>
                                                    </c:if>
                                                </tr>
                                            </c:if>
                                            <c:if test="${id_estado=='A' && item.id_estado==id_estado}">
                                                <tr onmouseover="onRowover(this)" onmouseout="onRowout(this)">
                                                    <td align="center" class="gridData"><% out.print(ce++);%></td>
                                                    <td class="gridData">${item.codigo}</td>
                                                    <td class="gridData">${item.paterno} ${item.materno} ${item.nombres}</td>
                                                    <c:if test="${id_curso!='C'}"><td class="gridData">${item.estado}</td></c:if>
                                                    <c:if test="${id_curso=='C'}">
                                            ...
                                            <c:if test="${id_estado=='R' && item.id_estado==id_estado}">
                                                <tr onmouseover="onRowover(this)" onmouseout="onRowout(this)">
                                                    <td align="center" class="gridData"><% out.print(ce++);%></td>
                                                    <td class="gridData">${item.codigo}</td>
                                                    <td class="gridData">${item.paterno} ${item.materno} ${item.nombres}</td>
                                            ...
                                            <c:if test="${id_estado=='NI' && item.id_estado==id_estado}">
                                                <tr onmouseover="onRowover(this)" onmouseout="onRowout(this)">
                                                    <td align="center" class="gridData"><% out.print(ce++);%></td>
                                                    <td class="gridData">${item.codigo}</td>
                                                    <td class="gridData">${item.paterno} ${item.materno} ${item.nombres}</td>
                                        ...
                                        <c:if test="${categoria=='F'}">
                                            <c:if test="${id_estado=='T' && item.id_sexo==categoria}">
                                                <tr onmouseover="onRowover(this)" onmouseout="onRowout(this)">
                                                    <td align="center" class="gridData"><% out.print(ce++);%></td>
                                                    <td class="gridData">${item.codigo}</td>
                                                    <td class="gridData">${item.paterno} ${item.materno} ${item.nombres}</td>
                                            ...
                                            <c:if test="${id_estado=='A' && item.id_estado==id_estado && item.id_sexo==categoria}">
                                                <tr onmouseover="onRowover(this)" onmouseout="onRowout(this)">
                                                    <td align="center" class="gridData"><% out.print(ce++);%></td>
                                                    <td class="gridData">${item.codigo}</td>
                                                    <td class="gridData">${item.paterno} ${item.materno} ${item.nombres}</td>
                                            ...
                                            <c:if test="${id_estado=='R' && item.id_estado==id_estado && item.id_sexo==categoria}">
                                                <tr onmouseover="onRowover(this)" onmouseout="onRowout(this)">
                                                    <td align="center" class="gridData"><% out.print(ce++);%></td>
                                                    <td class="gridData">${item.codigo}</td>
                                                    <td class="gridData">${item.paterno} ${item.materno} ${item.nombres}</td>
                                            ...
                                            <c:if test="${id_estado=='NI' && item.id_estado==id_estado && item.id_sexo==categoria}">
                                                <tr onmouseover="onRowover(this)" onmouseout="onRowout(this)">
                                                    <td align="center" class="gridData"><% out.print(ce++);%></td>
                                                    <td class="gridData">${item.codigo}</td>
                                                    <td class="gridData">${item.paterno} ${item.materno} ${item.nombres}</td>
