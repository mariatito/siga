<%-- 
    Document   : InformacionEstudiantesCurso
    Created on : 02-jul-2010, 22:41:10
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function selectGestion(id_gestion){
                window.location = '<c:url value="/informacionEstudiantesCurso.do"/>?id_gestion='+id_gestion;
            }
            function selectCurso(id_curso){
                window.location = '<c:url value="/informacionEstudiantesCurso.do"/>?id_gestion=${id_gestion}&id_curso='+id_curso;
            }
            ...
            function setImprimirResultado(){
                var printResultado=dhtmlmodal.open('windowMAQV', 'iframe', '<c:url value="/informacionEstudiantesCurso.do"/>?&imprimirPdf=_imprimirPdf&id_curso=${curso.id_curso}&id_gestion=${id_gestion}', 'Lista de resultados', 'width=650px,height=340px,left=100px,top=100px,resize=1,scrolling=1,center=1');
                printResultado.moveTo('middle', 'middle');
            }
            function getReporteExcel(){
                window.location = '<c:url value="/informacionEstudiantesCurso.do"/>?imprimirExcel=_imprimirExcel&id_curso=${curso.id_curso}&id_gestion=${id_gestion}'
            }
             function getReporteExcelCo(){
                window.location = '<c:url value="/informacionEstudiantesCurso.do"/>?imprimirExcelCo=_imprimirExcel&id_curso=${curso.id_curso}&id_gestion=${id_gestion}'
            }
        </script>
    ...
    <body>
        <div class="headercontent">
                    ...
                    <td style="width:60%">
                        <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
                            <tr>
                                ...
                                <td class="tab_current">Informaci&oacute;n del alumnado por curso</td>
            ...
            <div class="titlepage">INFORMACI&Oacute;N DEL ALUMNADO POR CURSO ${id_gestion}</div>
        </div>
        <div class="maincontent">
                        ...
                        <td>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF">
                                ...
                                <c:forEach varStatus="j" var="item" items="${cursos}">
                                    <tr onmouseover="onRowover(this)" onmouseout="onRowout(this)" onclick="selectCurso('${item.id_curso}')" style="cursor:pointer">
                                        <td align="center" style="cursor:pointer" valign="top" class="gridData">${j.count}</td>
            ...
            <c:if test="${!empty estudiantes}">
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%; cursor: pointer" class="gridContent">
                    <tr>
                        <td class="tableHeader">Lista de estudiantes</td>
                    </tr>
                    <tr>
                        <td>
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td>
                                        ...
                                        <button class="button-normal" onclick="getReporteExcel()" title="Reporte en formato excel"><img src="imagenes/iconos_sigaa/excel.png" width="11px">&nbsp;&nbsp;Reporte Excel</button>&nbsp;
                                         <button class="button-normal" onclick="getReporteExcelCo()" title="Reporte en formato excel"><img src="imagenes/iconos_sigaa/excel.png" width="11px">&nbsp;&nbsp;Reporte Excel solo Correos</button>&nbsp;
                                   
                                    </td><td><a href="mailto:${correos}">enviar email</a>${correos}</td>
