<%-- 
    Document   : EstudiantesByCurso
    Created on : 27-mar-2010, 9:59:59
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function selectGestion(id_ges){
                window.location = '<c:url value="/estudiantesByCurso.do"/>?id_gestion='+id_ges;
            }
            ...
            function setImprimirExcelGeneral(){
                window.location = '<c:url value="/estudiantesByCurso.do"/>?id_gestion=${id_gestion}&id_curso=${id_curso}&categoria=${categoria}&opcion=GENERAL&accion=_imprimir';
            }
        </script>
    </head>
    <body>
        <div class="headercontent">
            <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
                <tr>
                    ...
                    <td style="width:30%">
                        <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
                            <td class="tab_current">Estudiantes y fechas de nacimiento</td>
                        </table>
                    </td>
                    <td class="tab_fin">&nbsp;</td>
                </tr>
            </table
            <div class="titlepage">ESTUDIANTES Y FECHAS DE NACIMIENTO</div>
        </div>
        <div class="maincontent">
            ...
            <c:if test="${!empty question}">
                <form action="<c:url value="/estudiantesByCurso.do"/>" method="post" name="formConsultas">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="gridContent">
                        <tr>
                            ...
                            <td width="35%" class="opcionConsulta">Estudiantes y fechas de nacimiento</td>
                        </tr>
                        <tr>
                            <td>CURSO</td>
                        ...
                        <tr>
                            <td colspan="5" align="center">
                                <input type="hidden" name="opcion" value="GENERAL">
                    ...
                    <tr>
                        <td>
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td class="text-label"><button class="button-normal"  onclick="setImprimirExcelGeneral()" title="Imprimir documento en excel">Imprimir Excel</button>&nbsp;</td>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF">
                                    <tr>
                                        ...
                                        <c:if test="${id_curso=='C'}">
                                            ...
                                            <td class="gridHeaders" width="25%">Fecha de nacimiento</td>
                                    ...
                                    <c:forEach varStatus="i" var="item" items="${curso.estudiantes}">
                                        ...
                                        <c:if test="${categoria=='F' && item.id_sexo==categoria}">
                                            <tr onmouseover="onRowover(this)" onmouseout="onRowout(this)">
                                                <td align="center" class="gridData"><% out.print(cont++);%></td>
                                                <td class="gridData">${item.codigo}</td>
                                                <c:if test="${id_curso!='C'}">
                                                    <td class="gridData">${item.paterno} ${item.materno} ${item.nombres}</td>
                                                    <td class="gridData">${item.sfecha_nacimiento}</td>
