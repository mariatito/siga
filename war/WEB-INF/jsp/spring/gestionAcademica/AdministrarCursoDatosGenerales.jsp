<%-- 
    Document   : AdministrarCursoDatosGenerales
    Created on : 22-01-2010, 11:29:13 AM
                ...
                <tr>
                    ...
                    <td style="width:60%">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <td class="tab_current">Datos Generales</td>
        ...
        <c:if test="${!empty curso}">
            <div class="maincontent">
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100% ; cursor:pointer">
                    <tr>
                        <td class="tableHeader">Estudiantes de la materia</td>
                    </tr>
                    <tr>
                        <td class="gridContent">
                            <button class="button-normal"  onclick="javascript:setImprimirListaPdf('${curso.id_curso}')">Imprimir lista PDF</button>&nbsp;
                            <button class="button-normal"  onclick="javascript:imprimirListaPdfS('${curso.id_curso}','${id_gestion}')">Imprimir pre-actas</button>&nbsp;
                            <button class="button-normal"  onclick="javascript:imprimirListaPdfSS('${curso.id_curso}','${id_gestion}')">Imprimir acta-oficial</button>&nbsp;
                            <div id="resultlayer2">
