<%-- 
    Document   : BoletinesTrimestralesBoletinEstudiante
    Created on : 27-01-2010, 11:42:27 PM
    ...
    <body>
        <div class="headercontent">
            <table style="width:100%" cellspacing="0" cellpadding="0">
                <tr>
                    <td><h2>Boletin Trimestral</h2></td>
                </tr>
            </table>
        </div>
        <div class="maincontent">
            <span>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="gridDatS">
                    <c:if test="${curso.id_curso=='K' ||curso.id_curso=='K1'||curso.id_curso=='K21'||curso.id_curso=='K12'}">
                    ...
                    <c:if test="${parciales==2}">
                        <tr>
                            <td class="gridCuatron">ASIGNATURAS</td>
                            <td colspan="3">
                                <table border="0" width="100%" style="cursor:pointer" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td align="center" colspan="3" class="gridUno"><font style="font-size:11px">1er. BIMESTRE</font></td>
                                    </tr>
                                    <c:if test="${curso.id_curso!='K'&&curso.id_curso!='K1'&&curso.id_curso!='K12'&&curso.id_curso!='K21'}">
                                        <tr>
                                            <td align="center" width="5%" title="Promedio Conociemiento" class="gridUno"><font style="font-size:10px">PC</font></td>
                            ...
                            <td colspan="3">
                                <table border="0" width="100%" style="cursor:pointer" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td align="center" colspan="3" class="gridDos"><font style="font-size:11px">2do. BIMESTRE</font></td>
                                    </tr>
                                    <c:if test="${curso.id_curso!='K'&&curso.id_curso!='K1'&&curso.id_curso!='K12'&&curso.id_curso!='K21'}">
                                        <tr>
                                            <td align="center" width="5%" title="Promedio Conociemiento" class="gridDos"><font style="font-size:10px">PC</font></td>
                            ...
                            <td colspan="3">
                                <table border="0" width="100%" style="cursor:pointer" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td align="center" colspan="3" class="gridTres"><font style="font-size:11px">3er. BIMESTRE</font></td>
                                    </tr>
                                    <c:if test="${curso.id_curso!='K'&&curso.id_curso!='K1'&&curso.id_curso!='K12'&&curso.id_curso!='K21'}">
                                        <tr>
                                            <td align="center" width="5%" title="Promedio Conociemiento" class="gridTres"><font style="font-size:10px">PC</font></td>
                            ...
                            <td colspan="3">
                                <table border="0" width="100%" style="cursor:pointer" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td align="center" colspan="3" class="gridTres"><font style="font-size:11px">4to. BIMESTRE</font></td>
                                    </tr>
                                    <c:if test="${curso.id_curso!='K'&&curso.id_curso!='K1'&&curso.id_curso!='K12'&&curso.id_curso!='K21'}">
                                        <tr>
                                            <td align="center" width="5%" title="Promedio Conociemiento" class="gridTres"><font style="font-size:10px">PC</font></td>
                    ...
                    <c:forEach varStatus="i" var="item" items="${curso.materias}">
                        <c:if test="${curso.id_curso!='K'&&curso.id_curso!='K1'&&curso.id_curso!='K12'&&curso.id_curso!='K21' && curso.id_curso!='S1' && curso.id_curso!='S2' && curso.id_curso!='S3' && curso.id_curso!='S4'}">
                            <tr onmouseover="onRowover(this)" onmouseout="onRowout(this)" style="cursor: pointer" >
                                <td style="color:navy;font-weight: bold;padding-left: 5px;border-bottom: 1px solid #ccc" rowspan="2">${item.materia}</td>
                                <c:forEach varStatus="j" var="eva" items="${item.evaluaciones}">
                                    <c:if test="${j.count==1}">
                                        ...
                                        <td align="center" width="5%" class="gridUnon">
                                            <strong>
                                                <c:if test="${(eva.nota+eva.dps)>=36}">
                                                    ${eva.nota+eva.dps}
                                                </c:if>
                                                <c:if test="${(eva.nota+eva.dps)<=35}">
                                    ...
                                    <c:if test="${j.count==2}">
                                        ...
                                        <td align="center" width="5%" class="gridData">${eva.dps}</td>
                                        <td align="center" width="5%" class="gridDosn">
                                            <strong>
                                                <c:if test="${(eva.nota+eva.dps)>=36}">
                                                    ${eva.nota+eva.dps}
                                                </c:if>
                                    ...
                                    <c:if test="${j.count==3}">
                                        ...
                                        <td align="center" width="5%" class="gridData">${eva.nota}</td>
                                        <td align="center" width="5%" class="gridData">${eva.dps}</td>
                                        <td align="center" width="5%" class="gridTresn">
                                            <strong>
                                                <c:if test="${(eva.nota+eva.dps)>=36}">
                                                    ${eva.nota+eva.dps}
                                                </c:if>
                                    ...
                                    <c:if test="${j.count==4 && parciales==2}">
                                        <% int cont1 = 0;%>
                                        <td align="center" width="5%" class="gridData">${eva.nota}</td>
                                        <td align="center" width="5%" class="gridData">${eva.dps}</td>
                                        <td align="center" width="5%" class="gridTresn">
                                        ...
                                        <td align="left" width="5%" rowspan="2" style="vertical-align: top;text-align: center;padding-top: 2px">
                                            <strong>
                                                <c:if test="${eva.pa>=36}">
                                                    ${eva.pa}
                                                </c:if>
                            ...
                            <tr onmouseover="onRowover(this)" onmouseout="onRowout(this)" style="cursor: pointer" >
                                <c:forEach varStatus="j" var="eva" items="${item.evaluaciones}">
                                    <c:if test="${j.count==1}">
                                        <td class="gridData" colspan="3">${eva.cualitativa}</td>          
                                    </c:if>
                                    <c:if test="${j.count==2}">
                                        <td class="gridData" colspan="3">${eva.cualitativa}</td>  
                                    </c:if>
                        ...
                        <c:if test="${curso.id_curso=='K'||curso.id_curso=='K1'||curso.id_curso=='K21'||curso.id_curso=='K12' || curso.id_curso=='S1' || curso.id_curso=='S2' || curso.id_curso=='S3' || curso.id_curso=='S4'}">
                            <tr onmouseover="onRowover(this)" onmouseout="onRowout(this)" style="cursor: pointer">
                                <td style="color:navy;font-weight: bold;padding-left: 5px">${item.materia}</td>
                                <c:forEach varStatus="j" var="eva" items="${item.evaluaciones}">
                                    <c:if test="${j.count==1}">
                                        <c:if test="${curso.id_curso!='K'&&curso.id_curso!='K1'&&curso.id_curso!='K12'&&curso.id_curso!='K21'}">
                                            <td align="center" width="5%" class="gridData" id="${eva.id_evaluacion}-${estudiante.id_estudiante}">${eva.nota}</td>
                                    ...
                                    <c:if test="${j.count==3}">
                                        <c:if test="${curso.id_curso!='K'&&curso.id_curso!='K1'&&curso.id_curso!='K12'&&curso.id_curso!='K21'}">
                                            ...
                                            <td align="left" width="5%" style="vertical-align: top">&nbsp;&nbsp;&nbsp;&nbsp;<strong><c:if test="${eva.pa>=36}">${eva.pa}</c:if><c:if test="${eva.pa<=35}"><font style="color:red">${eva.pa}</font></c:if></strong></td>
                                                        <c:forEach varStatus="m" var="ev" items="${item.evaluaciones}">
                                                            <c:if test="${m.count==4}">
                                                                <% cont2 = 1;%>
                    ...
                    <tr>
                        ...
                        <c:forEach varStatus="i" var="fal" items="${curso.faltas}">
                            <td colspan="3">
                                <table border="0" width="100%" style="cursor:pointer" cellpadding="0" cellspacing="0">
                                    <c:forEach varStatus="j" var="con" items="${curso.conductas}">
                                        <c:if test="${i.count==j.count && curso.id_curso!='K'&&curso.id_curso!='K1'&&curso.id_curso!='K12'&&curso.id_curso!='K21'}">
                                            <c:if test="${i.count==1}">
                                                <tr>
                                            ...
                                            <c:if test="${i.count==4}">
                                                <tr>
                                                    <td align="center"><font style="font-size:12px"><strong>${curso.ptrim4}</strong></font></td>
                                                </tr>
                                            </c:if>
                                            <tr>
