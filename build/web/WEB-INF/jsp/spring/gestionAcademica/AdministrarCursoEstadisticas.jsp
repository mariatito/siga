<%-- 
    Document   : AdministrarCursoEstadisticas
    Created on : 02-02-2010, 10:15:38 AM
                ...
                <tr>
                    ...
                    <td style="width:60%">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            ...
                            <td class="tab_current">Estadisticas</td>
                        </table>
                    </td>
                    <td class="tab_fin">&nbsp;</td>
                </tr>
        ...
        <c:if test="${!empty curso}">
            <div class="maincontent">
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100% ; cursor:pointer">
                    <tr>
                        <td class="tableHeader">Módulo de estadisticas</td>
                    </tr>
                    <tr>
                        <td align="center">
