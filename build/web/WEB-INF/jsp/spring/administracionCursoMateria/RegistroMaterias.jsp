<%-- 
    ...
    Created on : 19-jun-2009, 20:30:06
    ...
    <body>
        ...
        <div class="headercontent">
            <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
                <tr>
                    ...
                    <td style="width:50%">
                        <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
                            <td class="tab_current">Registrar materias</td>
                            <td class="tab_normal" onclick="javascript:window.location='<c:url value="/actualizarMaterias.do"/>'">Actualizar datos</td>
            ...
            <div class="titlepage">REGISTRAR MATERIAS</div>
        </div>
        ...
        <div class="maincontent">
            ...
            <div id="formRegistroPersona" class="formPanel">
                <form action="<c:url value="/registrarMaterias.do"/>" method="post" name="MiForm" onsubmit="return setRegistrar(this)">
                    <table width="800" border="0" cellpadding="0" cellspacing="0">

                        <tr>
                            <td align="center"colspan="7"><p><strong>REGISTRO DE GESTION ACADEMICO</strong></p></td>
                        </tr>
                        <tr>
                            <td width="14%"></td>
                        ...
                        <tr>
                            ...
                            <td colspan="1">:</td>
                            <td colspan="4"><input class="text-field" type="text" name="id_materia" value="${id_materia}" maxlength="100" style="width:250px"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="1">:</td>
                            <td colspan="4"><input class="text-field" type="text" name="materia" value="${materia}" maxlength="100" style="width:250px"/></td>
                        </tr>
                        <tr>
                            <td colspan="7"><img src="imagenes/pixel_trans.gif" height="5"/></td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="1">:</td>
                            <td colspan="4"> <input name="promocionable" type="radio" value="${promocionable}" /></td>
                        </tr>
                        <tr>
                            <td colspan="7"><img src="imagenes/pixel_trans.gif" height="5"/></td>
                        </tr>
                    ...
                    <div id="finalizarRegistro" style="display:none">
                        <div class="formPanel">
                            <p>Confirma para establecer el registro de la materia.</p>
