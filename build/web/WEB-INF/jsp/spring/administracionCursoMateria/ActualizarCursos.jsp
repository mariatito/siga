        ...
        <script type="text/javascript">
            ...
            function confirmReg() {
             ...
             function selectCurso(id) {
                window.location='<c:url value="/actualizarCursos.do"/>?id_curso='+id;
            }
        </script>
    </head>
    <body>
        ...
        <div class="maincontent">
            ...
            <c:if test="${empty cursos}">
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
                    <tr>
                        <td class="tableHeader">Cursos registrados</td>
                    </tr>
                    <tr>
                            ...
                            <div id="resultlayer1">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF">
                                    <tr>
                                        ...
                                        <td class="gridHeaders" style="width:500px">Descripci&oacute;n</td>
                                    </tr>
                                    <c:if test="${empty curso}">
                                        <tr>
                                            <td class="gridData" colspan="3">Ningun registro encontrado</td>
                                        </tr>
                                    </c:if>
            ...
            <c:if test="${!empty visualizar}">
                <div id="formRegistroPersona" class="formPanel">
                    <form action="<c:url value="/actualizarCursos.do"/>" method="post" name="MiForm" onsubmit="return setRegistrar(this)">
                        <table width="800" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td colspan="1">:</td>
                                <td colspan="4"><input class="text-field" type="text" name="id_curso" value="${visualizar.id_curso}" maxlength="2" style="width:50px"/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="1">:</td>
                                <td colspan="4"><input class="text-field" type="text" name="curso" value="${visualizar.curso}" maxlength="100" style="width:200px"/></td>
                            </tr>
                            <tr>
                                <td colspan="7"><img src="imagenes/pixel_trans.gif" height="5"/></td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="1">:</td>
                                <td colspan="4"><input class="text-field" type="text" name="ciclo" value="${visualizar.ciclo}" maxlength="15" style="width:100px"/></td>
                            </tr>
                            <tr>
                                <td colspan="7"><img src="imagenes/pixel_trans.gif" height="5"/></td>
                            </tr>
                        ...
                        <div id="finalizarRegistro" style="display:none">
                            <div class="formPanel">
                                <p>Confirma para establecer la actualizacion del curso</p>
