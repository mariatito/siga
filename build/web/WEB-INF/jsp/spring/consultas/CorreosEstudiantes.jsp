<%-- 
    Document   : CorreosEstudiantes
    Created on : 18-oct-2011, 12:46:34
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function selectGestion(id_ges){
                window.location = '<c:url value="/correosEstudiantes.do"/>?id_gestion='+id_ges;
            }
            ...
            function setImprimirExcelGeneral(){
                window.location = '<c:url value="/correosEstudiantes.do"/>?id_gestion=${id_gestion}&id_curso=${id_curso}&categoria=${categoria}&opcion=GENERAL&accion=_imprimir';
            }
        </script>
    </head>
    <body>
        <div class="headercontent">
            <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
                <tr>
                    ...
                    <td style="width:30%">
                        <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
                            <td class="tab_current">Estudiantes y Correos eléctronicos por Curso</td>
                        </table>
                    </td>
                    <td class="tab_fin">&nbsp;</td>
                </tr>
        ...
        <div class="maincontent">
            ...
            <c:if test="${!empty question}">
                <form action="<c:url value="/correosEstudiantes.do"/>" method="post" name="formConsultas">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="gridContent">
                        <tr>
                            ...
                            <td width="35%" class="opcionConsulta">Estudiantes y Correos eléctronicos por Curso</td>
                        </tr>
                        <tr>
                            <td>CURSO</td>
